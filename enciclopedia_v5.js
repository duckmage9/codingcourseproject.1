/**
 * ENCICLOPÉDIA GAMEDEV - VERSÃO V5
 * Conteúdo: HTML Iniciante - 3 Parágrafos por tópico + Exemplos
 */
...
&lt;/head&gt;</code></pre></div>`,
    ...
    "Atributos e IDs": `
        ...
        <p>Na prática, IDs são muito usados para localizar partes específicas da interface do jogo. Um contador de pontos pode receber um id para que o JavaScript atualize seu valor em tempo real durante a partida. Já atributos como src permitem carregar imagens de personagens ou sons do jogo. Classes também ajudam a aplicar estilos semelhantes em vários elementos diferentes. Essa combinação facilita a construção de interfaces organizadas e dinâmicas.</p>
